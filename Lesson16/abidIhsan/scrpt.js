...
function removeDuplicates(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (!arrayWithoutDuplicate.includes(arr[i])) {
      arrayWithoutDuplicate.push(arr[i])
    }
  }
  console.log(arrayWithoutDuplicate);
}  
removeDuplicates([1,2,3,3,3,4,4,4,5,5,5,5,6]);
/*
...
filterLongWords("Hey, what is going on over there?".split(" "), 4);
/*
...
countOccurrences(["lost", "star", "planet", "star", "star"], "star");
/*
...
removeFalsyValues([0,1,2,false,"",null,5,6,undefined,7,"Hi",NaN]);
/*
...
findWordsWithLetter(["apple", "banana", "date"], "a");
/*
...
manageQueue(["Go","back","left"], "right");
/*
...
updateTodoList(todoList, 1,2,'Play Games');
