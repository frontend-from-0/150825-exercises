...
const sayi2 = 10;
const sayi3 = 15;
const totalSum = sayi1 + sayi2 + sayi3;
...
// CODE HERE
let counter = 0;
console.log('Ex.22', 'counter++:', counter++);
...
// CODE HERE
let numberEx9 = 6;
console.log('Ex.24', 'Returned Value:', ++numberEx9, 'Variable Value:', numberEx9);
// 25. Declare numberEx10=8. Increment it using the postfix ++ operator and log both the original variable and the incremented value.
// CODE HERE
let numberEx10 = 8;
console.log('Ex.25', 'Returned Value:', numberEx10++, 'Variable Value:', numberEx10);
...
let aEx27 = 2;
const bEx27 = 3;
console.log('Ex.27', ++aEx27 + bEx27); // (2 + 1) + 3