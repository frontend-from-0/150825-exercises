...
checkFileExtension('coding.pdf');
checkFileExtension('coding');
...
truncateString("I learn javascript", 10);
...
censorWord("this computer computer is logged", "computer");
...
function titleCase(sentence) {
    ...
    let titleCasedWords = words.map(word => word[0].toUpperCase() + word.slice(1));
    let result = titleCasedWords.join(" ");
    console.log(result);
}

titleCase("hello world from jihane");
...
function isSpam(text) {
  ...
  if (lowerText.includes('spam')) {
    console.log('this text is a spam')
...
function getInitials(fullName) {
    ...
    let initials = parts.map(name => name[0].toUpperCase());
...
reverseWords("JavaScript is easy");    
...
findWordPosition("Hello World", "Java"); 
