...
const sentencesWithTenWords = sentencesExercise5.filter(sentence => sentence.split(' ').length <= 10);
console.log(sentencesWithTenWords);
...
const wordWithFive = wordsExercise8.filter(word => word.length <= 5);
console.log(wordWithFive);
...
const wordWithoutJ = usersExercise10.filter(user => !user.name.toLowerCase().startsWith('j'));
console.log(wordWithoutJ);