...
const sentencesWithTenOrLessWords = sentencesExercise5.filter(sentence => sentence.split(' ').length <= 10);
...
const startsWithJ = usersExercise10.filter(user => user.name.startsWith('J'));
