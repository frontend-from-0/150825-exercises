...
findMax(numbersEx2);
console.log(findMax(numbersEx2));

const maxNumber2 = numbersEx2.reduce((max, current) => {
...
const averageNumbers =
  numbersEx4.reduce((accumulator, currentVal) => {
    return accumulator + currentVal;
  }, 0) / numbersEx4.length;

console.log(averageNumbers); // Output: 30
