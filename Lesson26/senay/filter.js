...
console.log("------ ------- ------- ------");
console.log(`Exercise5: ${sentencesMoreThan10Words}`);
...
const wordsMoreThan5Letter = wordsExercise8.filter(
  (word) => word.split("").length > 5,
);

console.log("------ ------- ------- ------");
console.log(wordsMoreThan5Letter);
...
console.log("------ ------- ------- ------");
console.log(studentsWithGradeLowerThanC);
