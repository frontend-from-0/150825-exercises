...
{
console.log('This is a PDF filename.');
}
else{
...
function isLongString(str) {
  if (str.length > 10) console.log('Long string');
...
function getSeason(monthNum) {
  if ([12, 1, 2].includes(monthNum)) console.log('Winter');
  else if ([3, 4, 5].includes(monthNum)) console.log('Spring');
  else if ([6, 7, 8].includes(monthNum)) console.log('Summer');
  else if ([9, 10, 11].includes(monthNum)) console.log('Autumn');
...
function containsNumber(str) {
  if (/\d/.test(str)) console.log('Contains number');
  else console.log('No number found');
}

containsNumber('abc123');
containsNumber('abcdef');
