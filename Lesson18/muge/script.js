...
*/
  ...
  get total () {
    console.log(`The total of the all products: ${this.#total} USD`);
    return this.#total;
  }
  ...
  applyDiscount(code) {
    ...
    if (discountCodes.hasOwnProperty(code)) {
      ...
      console.log(`Success! Code "${code}" applied. You saved ${discountAmount} USD. New total: ${this.#total} USD`);
    } else {
      console.error('Invalid discount code. Please try again.');
    }
  }
...
shoppingCart1.applyDiscount('WELCOME50');
shoppingCart1.total;
